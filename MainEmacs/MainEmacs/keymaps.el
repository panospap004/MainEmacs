...
(start/leader-keys
  ...
  "o a" '(org-agenda :wk "Org agenda")
	"o n" '(org-capture :wk "Notes/TODOS/Captures")
...
(start/leader-keys
  ...
  "t T" '(my/switch-theme-clean :wk "Load theme properly")
	"t c" '(counsel-colors-emacs :wk "List of emacs colors")
	"t C" '(counsel-colors-web :wk "List of css colors")
	)
